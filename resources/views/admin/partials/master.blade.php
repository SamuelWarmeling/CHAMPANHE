                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                        ...
                        <div class="dropdown-menu dropdown-menu-right pb-0">
                            <a class="dropdown-item" href="{{url('admin/secured/profile/update')}}"><i class="bx bx-user mr-50"></i>
                                Edit Profile</a>
                            <a class="dropdown-item" href="https://t.me/profelartech"><i class="bx bx-envelope mr-50"></i> My Inbox</a>
                            <a class="dropdown-item" href="{{route('admin.changepassword')}}"><i
                                    class="bx bx-lock mr-50"></i> Change Password</a>
                                
                            <a class="dropdown-item" href="https://t.me/profelartech">
                                <i class="bx bxl-telegram mr-50 telegram-blue"></i> Telegram
                                       </a>
...
{{--            </li>--}}
           ...
           <!-- <li class="@if($route == 'admin.purchase.index') active @else @endif">
            ...
            <li class="nav-item @if($route == 'admin.withdraw.pending' || $route == 'admin.withdraw.rejected' || $route == 'admin.withdraw.approved' || $route == 'admin.withdraw.process') sidebar-group-active open active @else @endif">
                ...
                <ul class="menu-content">
                   ...
                   <!-- <li class="@if($route == 'admin.withdraw.process') active @else @endif">
                        <a href="{{route('admin.withdraw.process')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Processing Withdraw</span></a></li>-->
                    ...
                    <li class="@if($route == 'admin.withdraw.process') active @else @endif">
                        <a href="{{route('admin.withdraw.proofs')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Withdraw Proof</span></a></li>
                </ul>
            </li>
          ...
          <li class="@if($route == 'admin.withdraw.process') active @else @endif">
                        <a href="{{route('admin.withdraw.proofs')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Withdraw Proof list</span></a></li>
...
">
    ...
    <div id="chatMenu" style="
        ...
        gap: 10px;
    ">
        <a href="https://t.me/profelar_su" target="_blank" style="
            display: flex;
            align-items: center;
            gap: 8px;
            padding: 10px 15px;
            ...
            transition: 0.3s;
        ">
            <img src="https://profelar.com/telegram-icon-free-png.webp" style="width:24px;height:24px;" /> Telegram
        </a>

        <a href="https://wa.me/+8801569110030" target="_blank" style="
            display: flex;
            align-items: center;
            gap: 8px;
            padding: 10px 15px;
            ...
            transition: 0.3s;
        ">
            <img src="https://profelar.com/logo-whatsapp-png-pic-0.png" style="width:24px;height:24px;" /> WhatsApp
        </a>

        <a href="https://tawk.to/chat/67fa744d5fbaa9190d3e370c/1iol5ckk5" target="_blank" style="
            display: flex;
            align-items: center;
            gap: 8px;
            padding: 10px 15px;
            ...
            transition: 0.3s;
        ">
            <img src="https://profelar.com/pngtree-hacker-safe-security-hacker-vector-png-image_34757466.png" style="width:24px;height:24px;" /> Anonymous
        </a>
    </div>
    ...
    ">
        <img src="https://cdn-icons-png.flaticon.com/128/589/589708.png" style="width:28px;height:28px;" />
    </button>
