  ...
  <div style="margin: 20px"> 
   ...
   <div> 
    <div class="common_card position"> 
     <a href="" class="flex_space padding bottom_order"> <p class="label">Retiradaal status</p> <p class="value"> <span style="color: #FF8725">in review</span> </p> </a> 
     <a href="" class="flex_space padding bottom_order"> <p class="label">Depósito Amount </p> <p class="value position"> <span class="unit">Rs</span>2000.00</p> </a> 
