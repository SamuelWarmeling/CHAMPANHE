<html>
 ...
 <body class="common_background" style="background-image: url(/v2/img/order/bg1.png);"> 
  <div class="common_header"> 
   <a href="javascript:history.back(-1)" class="back position"> <p class="btn"><i class="layui-icon layui-icon-left layui-font-20"></i></p> Team 3 Member </a> 
  </div> 
  <div style="margin: 15px;margin-top:20px;background: #ffffff;border-radius: 16px;"> 
   <div class="common_nav_menu flex_space" style="background: none;border-bottom: 1px solid #E8E8E8;border-radius: 0px;"> 
    <a href="/member/1" class="nav position" style="text-align: center;width: 32%;" data-type="" data-image="all"> <p class="title">Level 1</p> </a> 
    <a href="/member/2" class="nav position " style="text-align: center;width: 32%" data-image="normal"> <p class="title">Level 2</p> </a> 
    <a href="/member/3" class="nav nav_active position " style="text-align: center;width: 32%" data-type="2" data-image="finish"> <p class="title">Level 3</p> </a> 
   </div> 
