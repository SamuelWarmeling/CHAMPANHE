...
<script id="TeamTpl" type="text/html">
    <div class="team_level_card">
        ...
        <div class="team_level_item_card" style="background: linear-gradient( 88deg, #EDE8DF 0%, #D6C9B0 100%);">
            <div class="flex_space">
        ...
        <div class="team_level_item_card" style="background: linear-gradient( 88deg, #EDE8DF 0%, #C8A96A 100%);">
            <div class="flex_space">
...
<div class="common_card common_margin_15">
    <div id="team_level_card"> <div class="team_level_card"> <a href="/member/1" class="flex_space"> <div class="team_level_title">Nível de Equipe</div> <div class="team_level_details">Detalhes da Equipe &gt;</div> </a> <div class="team_level_item_card"> <div class="flex_space"> <div class="team_level_top_left"> Nível 1 </div> <img src="/v2/img/team/lv1.png" class="team_level_img"> </div> <div class="flex_space"> <div class="team_level_item_list flex_space"> <div class="team_level_item"> <div class="team_level_title">35%</div> <div class="team_level_details">Nível 1 Bônus</div> </div> <div class="team_level_item"> <div class="team_level_title">{{$first_level_users->count()}}</div> <div class="team_level_details">Total convidados</div> </div> <div class="team_level_item"> <div class="team_level_title">{{$first_level_users->where('investor', 1)->count()}}</div> <div class="team_level_details">Ativos</div> </div> </div> </div> </div> <div class="team_level_item_card" style="background: linear-gradient( 88deg, #EDE8DF 0%, #D6C9B0 100%);"> <div class="flex_space"> <div class="team_level_top_left" style=" background-image: url(&quot;/v2/img/team/lv2_bg.png&quot;);"> Nível 2 </div> <img src="/v2/img/team/lv2.png" class="team_level_img"> </div> <div class="flex_space"> <div class="team_level_item_list flex_space"> <div class="team_level_item"> <div class="team_level_title">2%</div> <div class="team_level_details">Nível 2 Bônus</div> </div> <div class="team_level_item"> <div class="team_level_title">{{$second_level_users->count()}}</div> <div class="team_level_details">Total convidados</div> </div> <div class="team_level_item"> <div class="team_level_title">{{$second_level_users->where('investor', 1)->count()}}</div> <div class="team_level_details">Ativos</div> </div> </div> </div> </div> <div class="team_level_item_card" style="background: linear-gradient( 88deg, #EDE8DF 0%, #C8A96A 100%);"> <div class="flex_space"> <div class="team_level_top_left" style=" background-image: url(&quot;/v2/img/team/lv3_bg.png&quot;);"> </div> <img src="/v2/img/team/lv3.png" class="team_level_img"> </div> <div class="flex_space"> <div class="team_level_item_list flex_space"> <div class="team_level_item"> <div class="team_level_title">1%</div> <div class="team_level_details">Nível 3 Bônus</div> </div> <div class="team_level_item"> <div class="team_level_title">{{$third_level_users->count()}}</div> <div class="team_level_details">Total convidados</div> </div> <div class="team_level_item"> <div class="team_level_title">{{$third_level_users->where('investor', 1)->count()}}</div> <div class="team_level_details">Ativos</div> </div> </div> </div> </div> </div> </div>
</div>
