    ...
    <div class="team_level_card">
        ...
        <div class="team_level_item_card">
            <div class="flex_space">
                ...
                <img src="/public/v2/img/team/lv1.png" class="team_level_img">
            </div>
            <div class="flex_space">
        ...
        <div class="team_level_item_card" style="background: linear-gradient( 88deg, #EAEEF7 0%, #D1D8F2 100%);">
            <div class="flex_space">
                <div class="team_level_top_left" style='    background-image: url("/public/v2/img/team/lv2_bg.png");'>
                    Leve2
                </div>
                <img src="/public/v2/img/team/lv2.png" class="team_level_img">
            </div>
            <div class="flex_space">
                <div class="team_level_item_list flex_space">
                    <div class="team_level_item">
        ...
        <div class="team_level_item_card" style="background: linear-gradient( 88deg, #F4D5D4 0%, #F5C1B4 100%);">
            <div class="flex_space">
                <div class="team_level_top_left" style='    background-image: url("/public/v2/img/team/lv3_bg.png");'>

                </div>
                <img src="/public/v2/img/team/lv3.png" class="team_level_img">
            </div>
            <div class="flex_space">
                <div class="team_level_item_list flex_space">
                    <div class="team_level_item">
...
<script src="/public/v2/js/team.js"></script>-->
