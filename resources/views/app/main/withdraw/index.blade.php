...
<div class="common_margin_15" id="balance_card" style="margin-top: 0"> <div class="common_margin_10 common_padding_10"> <div class="label" style="color: #DEEFFF">Saldo</div> <div class="value commission_amount common_margin_top_10" style="font-weight: 700;font-size: 22px;color: #FFFFFF;">{{ price(auth()->user()->balance) }}</div> </div> </div>
     ...
     <div class="demo-login-container"> 
      ...
      <div class="layui-form-item"> 
       <div class="layui-input-wrap"> 
        <input type="number" name="amount" id="withdrawal_amount" min="{{ $minWithdraw }}" max="{{ $maxWithdraw }}" value="" lay-verify="required" placeholder="Valor do saque  {{ $minWithdraw }}-{{ $maxWithdraw }}" autocomplete="off" class="layui-input"> 
       </div> 
      </div> 
      <div class="input_title">
       Senha de Transação
      ...
      <div class="layui-form-item">
       <div class="layui-input-wrap">
        <input style="" type="password" name="trade_password" value="" lay-verify="required" placeholder="Senha de transação" lay-reqtext="Senha de transação" autocomplete="off" class="layui-input" lay-affix="eye">
      ...
      <div class="fixed_bottom"> 
       <div style="padding: 10px 15px;"> 
        <div class="layui-form-item" style="margin-bottom: 0px;"> 
         <button class="layui-btn layui-btn-lg layui-btn-fluid layui-btn-radius withdraw_btn" id="withdraw" lay-submit="" lay-filter="withdraw">Solicitar Saque</button> 
        </div> 
       </div> 
      </div> 
      <a href="/withdraw/history" class="fixed_top_right" style="margin-top: 30px"> Histórico &gt; </a> 
     </div> 
    </form> 
   </div> 
  </div> 
   ...
   <div class="common_card_content"> 
    <div class="demo-login-container" style=""> 
     ...
     <div class="common_content"> 
      <p style="margin-bottom:10px;"> 1. Horário de saque: 09:00 – 16:30 </p>
      <p style="margin-bottom:10px;"> 2. Valor do saque entre {{ price($minWithdraw) }} e {{ price($maxWithdraw) }} </p>
      <p style="margin-bottom:10px;"> 3. Para facilitar a liquidação financeira, só é permitido 1 saque por dia </p>
      <p style="margin-bottom:10px;"> 4. Taxa de saque: {{ $withdrawCharge }}% </p> 
     </div> 
    </div> 
   </div> 
  </div>
