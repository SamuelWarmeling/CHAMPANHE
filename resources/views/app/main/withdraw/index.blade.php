<html>
 ...
 <body class="common_background" style="   background-image: url(/public/v2/img/user/deposito_bg.png);">
     ...
     <div class="demo-login-container"> 
      ...
      <div class="layui-form-item"> 
       <div class="layui-input-wrap"> 
        <input type="number" name="amount" id="retiradaal_amount" min="{{ $minRetirada }}" max="{{ $maxRetirada }}" value="" lay-verify="required" placeholder="Retiradaal amount  {{ $minRetirada }}-{{ $maxRetirada }}" autocomplete="off" class="layui-input"> 
       </div> 
      </div> 
      <div class="input_title">
      ...
      <div class="fixed_bottom"> 
       <div style="padding: 10px 15px;"> 
        <div class="layui-form-item" style="margin-bottom: 0px;"> 
         <button class="layui-btn layui-btn-lg layui-btn-fluid layui-btn-radius retirada_btn" id="retirada" lay-submit="" lay-filter="retirada">Apply Retiradaal</button> 
        </div> 
       </div> 
      </div> 
      <a href="/retirada/history" class="fixed_top_right" style="margin-top: 30px"> Record &gt; </a> 
     </div> 
    </form> 
   </div> 
  </div> 
   ...
   <div class="common_card_content"> 
    <div class="demo-login-container" style=""> 
     ...
     <div class="common_content"> 
      <p style="margin-bottom:10px;"> 1. Daily retiradaal time 09:00:00 - 16:30:00 </p> 
      <p style="margin-bottom:10px;"> 2. Retirada an amount between {{ price($minRetirada) }} and  {{ price($maxRetirada) }} </p> 
      <p style="margin-bottom:10px;"> 3. To facilitate financial settlement, you can only request retiradaal 1 times per day </p> 
      <p style="margin-bottom:10px;"> 4. Retiradaal rate: {{ $retiradaCharge }} percent </p> 
     </div> 
    </div> 
   </div> 
  </div>
