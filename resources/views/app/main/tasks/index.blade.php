...
<head> 
    ...
    <style>
        .common_body {
            background-image: url("/public/v2/img/tasks/bg.png");
            background-size: 100%;
        ...
        .tasks_progress {
            width: 90px;
            height: 30px;
            background-image: url("/public/v2/img/tasks/finish_bg.png");
            background-size: 100%;
            background-repeat: no-repeat;
            text-align: left;
            padding-top: 5px;
        ...
        .tasks_progress_active {
            width: 90px;
            height: 30px;
            background-image: url("/public/v2/img/tasks/progress_bg.png");
            background-size: 100%;
            background-repeat: no-repeat;
            text-align: left;
            padding-top: 5px;
        ...
        <div class="common_card common_margin_15" style="padding: 0"> 
            <div class="flex_left common_padding_15" style="padding-top: 15px"> 
                <div style="background: none;margin-right: 10px;"> 
                    <img src="/public/v2/img/tasks/rewards_icon.png" style="height: 70px;width: 70px"> 
                </div> 
                <div style="width: 100%"> 
