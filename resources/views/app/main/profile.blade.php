...
@endphp
  ...
  <a href="/vip" class="user_vip_card position common_margin_15" style="margin-bottom:0px;display: block"> 
      ...
      <div class="user_vip_card_left"> 
        ...
        <div> 
          ...
          <div style="margin-top:5px;color: #ffffff">
            Progresso atual {{ number_format($totalInvestment, 2) }} / {{ number_format($nextTarget, 2) }}
          </div> 
        </div> 
      </div> 
   ...
   <div class="index_menu common_margin_15"> 
    <a href="/orders" class="nav nav_active"> <img src="/v2/img/account/orders.png" style="width: 30px;height: 30px"> <p class="title">Meus Pedidos</p> </a>
    <a href="/balanceDetails" class="nav nav_active"> <img src="/v2/img/account/balance.png" style="width: 30px;height: 30px"> <p class="title">Meu Extrato</p> </a>
    <a href="/team" class="nav nav_active"> <img src="/v2/img/account/team.png" style="width: 30px;height: 30px"> <p class="title">Minha Equipe</p> </a>
    <a href="/add-bank" class="nav nav_active"> <img src="/v2/img/account/wallet.png" style="width: 30px;height: 30px"> <p class="title">Cartão Bancário</p> </a>
   </div> 
   <div class="common_card common_margin_15"> 
    ...
    <div class="flex_space" style="border-bottom: 1px solid #F6F6F6;padding: 10px 0"> 
     <div> 
      ...
      <div class="value recharge_balance" style="font-size: 18px;color: #C8A96A;font-weight: 700;margin-top: 10px;text-align: center">
     ...
     <div> 
      ...
      <div class="value withdraw_balance" style="font-size: 18px;color: #C8A96A;font-weight: 700;margin-top: 10px;text-align: center">
       {{ price(auth()->user()->balance) }}
      </div> 
     </div> 
    </div> 
    <div class="flex_space" style="border-bottom: 1px solid #F6F6F6;padding: 10px 0"> 
     <div> 
      ...
      <div class="value product_income" style="font-size: 18px;color: #C8A96A;font-weight: 700;margin-top: 10px;text-align: center">
     ...
     <div> 
      ...
      <div class="value order_num" style="font-size: 18px;color: #C8A96A;font-weight: 700;margin-top: 10px;text-align: center">
...
.card:hover {
  ...
  box-shadow: 0 6px 12px rgba(0,0,0,0.15);
   ...
   <div class="user_list" style="padding: 15px;border-radius:8px;text-align: center;"> 
    <a href="/logout" class="logout"><i class="layui-icon layui-icon-logout"></i> Sair</a> 
   </div> 
  </div> 
  ...
  <div class="footer_menu"> 
   <div class="content"> 
    ...
    <a href="/my" class="item active" style="margin-top: 10px;"> <img src="/v2/img/footer/account_active.png"> <p>Conta</p> </a> 
   </div> 
  </div> 
 </body>
</html>