  ...
  <div style="padding:16px">
    ...
    @if($withdrawals->isEmpty())
      <div class="empty-state">
        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="none" viewBox="0 0 24 24" stroke="#C8A96A" stroke-width="1.5" style="display:block;margin:0 auto 12px"><path stroke-linecap="round" stroke-linejoin="round" d="M17 9V7a5 5 0 00-10 0v2M3 9h18l-1.68 11.39A2 2 0 0117.34 22H6.66a2 2 0 01-1.98-1.61L3 9z"/></svg>
        <p>Nenhum saque encontrado.</p>
      </div>
    @else
      @foreach($withdrawals as $element)
        @php
