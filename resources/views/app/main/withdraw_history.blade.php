<html>
 ...
 <body class="common_background" style="background-image: url(/public/v2/img/order/bg1.png);"> 
  <div class="common_header"> 
   <a href="javascript:history.back(-1)" class="back position"> <p class="btn"><i class="layui-icon layui-icon-left layui-font-20"></i></p> retiradaRecord </a> 
  </div> 
  <div style="margin: 15px"> 
   ...
   <div style="margin-top:20px">
    ...
    @endphp
    <a ref="/depositoDetails/68202" class="common_card position" style="display:block"> 
